...
Contact links open the visitor’s email app with a prefilled subject; no contact submissions are stored or sent by a server. Project inquiries pass the selected project into the contact page and email subject.
